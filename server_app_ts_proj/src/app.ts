import { api_ping, api_user_get, api_whoami, custom_gameserver, debug_error, qh3server, routerserver, server_inf_reader, serversdk } from '@amudaliar/gsdk-serverplugin';
...
if (process.env.NODE_ENV === "production") {
    ...
    server_inf_reader.get_instance().load_config('./serverconfig.rel.inf');
} else {
