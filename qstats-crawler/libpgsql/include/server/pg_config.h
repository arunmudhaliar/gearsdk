...
#define CONFIGURE_ARGS " '--prefix=/Users/amudaliar/Downloads/postgresql-15.5/build'"
...
#define PG_VERSION_STR "PostgreSQL 15.5 on x86_64-apple-darwin21.6.0, compiled by Apple clang version 13.1.6 (clang-1316.0.21.2.5), 64-bit"
