...
public static string CalcBinFileToHex( string filename )
{
	if( !File.Exists( filename ) )
		return "Error";

	byte[] buff = File.ReadAllBytes( filename );
	return CalcToHex( buff );
}

public static int CalcFile( string filename )
{
	return CalcBinFile( filename );
}

public static string CalcFileToHex( string filename )
{
	return CalcBinFileToHex( filename );
}

public static int CalcTextFile( string filename )
{
	if( !File.Exists( filename ) )
		return -1;
...
public static string CalcTextFileToHex( string filename )
{
	if( !File.Exists( filename ) )
		return "Error";
...
/// <summary>
/// Calculates the CRC32 value and returns it as a hex string 0x00000000
/// </summary>
/// <param name="data"></param>
/// <returns></returns>
public static string CalcToHex( byte[] data )
{
	int i = Calc( data );
...
/// <param name="data"></param>
/// <returns></returns>
public static string CalcToHex( char[] data )
{
	int i = Calc( data );
	return String.Format( "{0:x8}", i );
}
...
/// <returns></returns>
public static string CalcToHex( string text )
{
	int i = Calc( text );
	return String.Format( "{0:x8}", i );
}
