...
class qstring {
   public:
	 ...
	 */
	qstring() { utstring_new(ut_string); }
	 ...
	 */
	long find(long start_pos, const qstring& sub_str) const { return utstring_find(ut_string, start_pos, sub_str.c_str(), sub_str.length()); }
	 ...
	 */
	const char* c_str() const { return utstring_body(ut_string); }
	 ...
	 */
	bool operator<(const qstring& other) const { return strcmp(utstring_body(ut_string), utstring_body(other.get_utstring())) < 0; }
	 ...
	 */
	void operator+=(const qstring& qstr) { utstring_concat(ut_string, qstr.get_utstring()); }
	 ...
	 */
	const UT_string* get_utstring() const { return ut_string; }
