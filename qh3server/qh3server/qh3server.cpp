...
Config *qh3server::config = NULL;
Config *qh3server::http3_config = NULL;
struct connections *qh3server::conns = NULL;
...
int qh3server::run(const std::string& host, const std::string& port) {
