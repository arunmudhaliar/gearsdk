...
int main(int argc, const char* argv[]) {
	...
	st_qh3router_config_in config(host, port, mongodb_uri, redis_ip, redis_port, rootDir, "./serverconfig.rel.inf", nullptr, 4010, port, zk_uri, 4005, "qh3sampleserver-app");
