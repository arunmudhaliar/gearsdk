...
extern "C" {
JNIEXPORT jboolean JNICALL Java_com_gearsdk_qunityplugin_qh3client_1android_send_1async_1request(JNIEnv* env, jobject thiz, jstring j_host, jstring j_port, jstring j_path, jstring j_payload, jobject arg, jobject request_cb_interface,
																								 jint retry) {
	...
	qh3client_helper::send_async_request<client::qh3client_android>(
		host, port, conn_io_req_res::create(path, payload), g_arg,
		[g_request_cb_interface](conn_io_req_res* request, conn_io_req_res* response, void* client_specific_data, void* arg, bool success) {
			...
			jmethodID callbackMethod = env1->GetMethodID(callbackClass, "callback_method", "(Ljava/lang/String;Ljava/lang/Object;Z)V");
